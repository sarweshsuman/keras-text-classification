...
class_category = ['CONFIDENTIAL','SFS','TOTAL_INDUSTRY_TESTING','EFC','CORPORATE','HR_MISC','AROUND_OFFERING','RAPID_NWTX']   # Change this if the order of classes while training a model changes
